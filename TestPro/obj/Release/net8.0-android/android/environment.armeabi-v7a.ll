...
@dso_cache = dso_local local_unnamed_addr global [744 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 216908349, ; hash 0xcedc23d, from name: OfficeOpenXml.Core.ExcelPackage
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1247348940, ; hash 0x4a5908cc, from name: libaot-TestPro.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1299727211, ; hash 0x4d78436b, from name: TestPro
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TestPro.dll.so
		ptr null; void* handle (0x0)
	}, ; 202
	...
	%struct.DSOCacheEntry {
		i64 1430234530, ; hash 0x553fa5a2, from name: OfficeOpenXml.Core.ExcelPackage.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.30_name, ; name: libaot-OfficeOpenXml.Core.ExcelPackage.dll.so
		ptr null; void* handle (0x0)
	}, ; 236
	...
	%struct.DSOCacheEntry {
		i64 1661032600, ; hash 0x63015898, from name: aot-OfficeOpenXml.Core.ExcelPackage
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.30_name, ; name: libaot-OfficeOpenXml.Core.ExcelPackage.dll.so
		ptr null; void* handle (0x0)
	}, ; 277
	...
	%struct.DSOCacheEntry {
		i64 2108306470, ; hash 0x7daa3426, from name: aot-OfficeOpenXml.Core.ExcelPackage.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.30_name, ; name: libaot-OfficeOpenXml.Core.ExcelPackage.dll.so
		ptr null; void* handle (0x0)
	}, ; 355
	...
	%struct.DSOCacheEntry {
		i64 2541742201, ; hash 0x977fe879, from name: libaot-OfficeOpenXml.Core.ExcelPackage
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.30_name, ; name: libaot-OfficeOpenXml.Core.ExcelPackage.dll.so
		ptr null; void* handle (0x0)
	}, ; 438
	...
	%struct.DSOCacheEntry {
		i64 3147943099, ; hash 0xbba1ccbb, from name: TestPro.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TestPro.dll.so
		ptr null; void* handle (0x0)
	}, ; 561
	%struct.DSOCacheEntry {
		i64 3159775502, ; hash 0xbc56590e, from name: libaot-OfficeOpenXml.Core.ExcelPackage.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.30_name, ; name: libaot-OfficeOpenXml.Core.ExcelPackage.dll.so
		ptr null; void* handle (0x0)
	}, ; 562
	...
	%struct.DSOCacheEntry {
		i64 3249386754, ; hash 0xc1adb502, from name: libaot-TestPro
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TestPro.dll.so
		ptr null; void* handle (0x0)
	}, ; 581
	...
	%struct.DSOCacheEntry {
		i64 3306058773, ; hash 0xc50e7415, from name: aot-TestPro
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TestPro.dll.so
		ptr null; void* handle (0x0)
	}, ; 592
	...
	%struct.DSOCacheEntry {
		i64 3857444133, ; hash 0xe5ebed25, from name: aot-TestPro.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-TestPro.dll.so
		ptr null; void* handle (0x0)
	}, ; 668
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [154 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
